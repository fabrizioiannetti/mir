...
public:
    ...
    XdgDecorationManagerV1(struct wl_display* display, uint32_t max_version);
...
public:
    ...
    XdgToplevelDecorationV1(struct wl_client* client, struct wl_resource* parent, uint32_t id);
    virtual ~XdgToplevelDecorationV1() = default;
